...
def _upgrade_sqlite_schema():
    ...
    case_additions = {
        ...
        "claimant_submission_ready": "BOOLEAN NOT NULL DEFAULT 0",
        "respondent_submission_ready": "BOOLEAN NOT NULL DEFAULT 0",
        "claimant_submission_ready_at": "TEXT",
        "respondent_submission_ready_at": "TEXT",
        "steward_json": "TEXT",
